...
final class OrganizerReactivatedEvent implements ShouldBroadcast
{
    use Dispatchable;
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'message' => 'Votre compte organisateur a été réactivé avec succès',
        ];
    }
}
