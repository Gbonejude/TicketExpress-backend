...
final class OrganizerSuspendedEvent implements ShouldBroadcast
{
    use Dispatchable;
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'message' => 'Votre compte organisateur a été suspendu temporairement',
        ];
    }
}
